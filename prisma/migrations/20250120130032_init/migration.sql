...
CREATE TABLE `Product` (
    ...
    `originSku` VARCHAR(191) NOT NULL,
    ...
    `createdBy` VARCHAR(191) NULL,
    `updatedBy` VARCHAR(191) NULL,
    `packingId` VARCHAR(191) NOT NULL,
...
-- AddForeignKey
ALTER TABLE `Product` ADD CONSTRAINT `Product_tierId_fkey` FOREIGN KEY (`tierId`) REFERENCES `Tier`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Product` ADD CONSTRAINT `Product_categoryId_fkey` FOREIGN KEY (`categoryId`) REFERENCES `Category`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE `Product` ADD CONSTRAINT `Product_packingId_fkey` FOREIGN KEY (`packingId`) REFERENCES `Packing`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE;
